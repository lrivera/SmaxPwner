...
public class MainActivity extends Activity implements ActionBar.TabListener {
    ...
    public class SectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position){
                case 0:
                    return RemoteFragment.newInstance(position + 1);
                case 1:
                    return LocalFragment.newInstance(position + 2);
                case 2:
                    return ParametrosFragment.newInstance(position + 3);
            default:
                return null;
            }
        }
    ...
    public static class LocalFragment extends Fragment {
        private static final String ARG_SECTION_NUMBER = "section_number";
        public static LocalFragment newInstance(int sectionNumber) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            TextView textView = (TextView) rootView.findViewById(R.id.section_local);
            textView.setText(Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
            return rootView;
        }
    }
    public static class ParametrosFragment extends Fragment {
        private static final String ARG_SECTION_NUMBER = "section_number";
        public static ParametrosFragment newInstance(int sectionNumber) {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
                                 Bundle savedInstanceState) {
            View rootView = inflater.inflate(R.layout.parametros, container, false);
            TextView textView = (TextView) rootView.findViewById(R.id.section_parametros);
            textView.setText(Integer.toString(getArguments().getInt(ARG_SECTION_NUMBER)));
            return rootView;
        }
    }
